...
pub trait Manager {
    ...
    async fn find_doc_mpath_by_url(&self, url: &str, fonds: &str) -> anyhow::Result<String>;
}
...
impl DocumentElement {
    ...
    #[must_use]
    pub const fn new(doc_mpath: String, url: String, doc_id: String, fonds: String) -> Self {
        Self {
            doc_mpath,
            url,
            doc_id,
